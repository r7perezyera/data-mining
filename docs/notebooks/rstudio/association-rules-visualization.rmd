...
# la siguiente línea se ejecutó en la consola de RStudio para mostrar el gráfico interactivo:
# se deja comentada para indicar que NO debe correrse dentro de la celda
