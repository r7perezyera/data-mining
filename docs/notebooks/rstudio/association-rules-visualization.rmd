---
title: "Ejercicios de Visualización de Association Rules Visualization - Exercices"
output:
  html_document:
    toc: true
    toc_float: true
...
Instalar los paquetes requeridos para este ejercicio arulesViz
...
Tip: Si ya instalaste los paquetes puedes colocar nuevamente cada línea en comentarios.
...
Trabajaremos con una muestra del 80% de los elementos del dataset. Para lograr resultados reproducibles asigna el valor de los dígitos de tu matrícula en el siguiente estatuto.

```{r}
STUDENT_ID = 0 #Sustituir por los dígitos de tu matrícula.
```
