...
En caso que no tengas insalados los paquetes de R requeridos para este notebook será necesario que retires los comentarios y ejecutes la siguiente celda.

El símbolo de comentarios en R es #

Tip: Si ya instalaste los paquetes puedes colocar cada línea en comentarios nuevamente.
...
Carga la librería arulesViz (carga automáticamente arules).
```{r echo=TRUE}
library("arulesViz")
```
